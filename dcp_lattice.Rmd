...
library(patchwork)
library(pracma)
#Nfine = 288 # 24 hr with 5 minute discretization
Nfine = 2^4 # 24 hr with 10 minute discretization
Nfreq = 2^3
Nmeas = 16 
...
min_lat = 4#floor(Nmeas/3)# min number of points in lattice
max_lat = min_lat#floor(2*Nmeas/3)# max number of points in lattice
...
constraints  = list( sum(x) == 4, t(w)%*%x == Nmeas)
