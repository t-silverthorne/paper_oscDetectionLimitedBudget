...
require(patchwork)
load_all()
amm=readRDS(file = 'results/output/batch_2024-02-06___13:48:44.021394/amm_all.RDS')
...
pmax=amm[amm@cts=='cts',] %>% {.@power} %>% max()
amm@best[amm@power==pmax & amm@cts=='cts']='best_continuous'
...
am_unif=annmatrix(as.matrix(pwrvals),
