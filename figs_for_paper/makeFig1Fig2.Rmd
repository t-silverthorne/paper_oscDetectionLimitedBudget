...
amm=helper_helper_update_amm(amm,Lnow,gset,tag='cts_arb_bfgs',wrapped=F)
...
amm=helper_helper_update_amm(amm,Lnow,gset,tag='cts_lat_bfgs',wrapped=T)
...
res = opt_osc_power(dvar0  = NULL,
             ...
             tau     = tau,
             regL1   = gset$regL1)
cvxr_am = helper_extract_info_from_result(res,'disc_arb_cvxr',gset$Nmeas)
...
amm=helper_helper_update_amm(amm,Lnow,gset,tag='cts_arb_sa',wrapped=F)
...
amm=helper_helper_update_amm(amm,Lnow,gset,tag='cts_lat_sa',wrapped=T)
...
amm=helper_helper_update_amm(amm,Lnow,gset,tag='disc_arb_sa',wrapped=F)
...
amm=helper_helper_update_amm(amm,Lnow,gset,tag='disc_lat_sa',wrapped=T)
```
