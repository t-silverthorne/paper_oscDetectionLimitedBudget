...
pdf[pdf$solver== 'supp_1hr',]$solver = 'pCHORD 1hr'
pdf[pdf$solver== 'supp_2hr',]$solver = 'pCHORD 2hr'
pdf[pdf$solver== 'supp_3hr',]$solver = 'pCHORD 3hr'
...
ggsave(paste0(overleaf_plot_directory,'optimality_compare.png'),Fig,width = 6,height=3,device='png',dpi=200)
