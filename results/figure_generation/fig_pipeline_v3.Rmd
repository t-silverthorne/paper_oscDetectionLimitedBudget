...
plt = sols %>% ggplot(aes(x=mt,y=1))+geom_point()+
...
pdf$outcome = factor(pdf$outcome,c(T,F,'time_out'),c('uniform optimal','non-uniform optimal','time limit'))
...
plt_width =6 
plt_height=7
Fig = plt_hmap/plt_raw/plt_app + plot_annotation(tag_levels='A')+
  plot_layout(heights=c(1,.8,1.5))
show_temp_plt(Fig,plt_width,plt_height)
