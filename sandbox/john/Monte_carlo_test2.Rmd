...
source("C:/Users/johnl/OneDrive/Documents/OED_Project/oscpaper/R/rowCosinor.R")
```
...
param <- c(amp, phase, period) #mu, amp, phase, and period
Outer_loop <- 10
Nmeas <- 4

zts <- linspace(0, 1, Nmeas)

xdat <- generate_data("gaussian", Outer_loop, Nmeas, param)
cosinor <- rowCosinor(xdat, zts)
```
