...
```{r}
{PDES | PDET | PPWR}+plot_annotation(tag_levels='A')+plot_layout(widths = c(1,1,2),guides='collect') &theme(legend.position = 'bottom',
        legend.direction = 'horizontal',
        legend.box = 'horizontal')
ggsave(paste0(overleaf_plot_directory,"fig_reduced_design_space.pdf"), width = 7, height =4.5)
